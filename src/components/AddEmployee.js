...
function AddEmployee(props) {
  ...
  return (
    <>
      ...
      <button onClick={handleShow} className='block mx-auto bg-indigo-600 hover:bg-black text-white font-bold py-2 px-4 my-3 rounded'>
        + Add Employee</button>
      ...
      >
                ...
                <div className="md:flex md:items-center mb-6">
                    ...
                    <div className="md:w-2/3">
                      <input 
                        ...
                        id="img" 
                        type="text"
                        placeholder='https://heythere.com' 
                        value={img}
                        onChange={(e) => {
        ...
        <Modal.Footer>
          ...
          <button className='bg-indigo-600 hover:bg-black text-white font-bold py-2 px-4 rounded' form='editmodal'>
            Add</button>
        </Modal.Footer>
      </Modal>
    </>
