                    ...
                    className="w-full max-w-sm mx-auto" 
                        ...
                        <div className='w-full h-100 mb-3'>
                            ...
                            <section className='h-[80%]'>
                                {members.map((member) => {
                                    return (
                                        <div key={uuidv4()} className='flex flex-row justify-between items-center mt-4 pb-3 border-b-2 border-gray-200'>
                                            <div className='flex flex-row items-center'>
                                                <div className='w-8 h-8'>
                                                    <MiniIMG member={member} />
                                                </div>
                                                <p className='mb-1 text-gray-500 ml-3 text-xl font-light'>{member.email}</p>
                                            </div>
                                            <div>
                                                {member.type === 1 ? 
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#b1b2ff" className="w-6 h-6">
                                                        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                                                    </svg>
                                                    : 
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#b2b2b2" className="w-6 h-6">
