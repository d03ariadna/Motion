            ...
            <div className="bg-white border-[1px] border-gray-200 w-[35%] h-full rounded-3xl flex flex-row ">
              <div className="w-[45%] pt-10 pl-8">
                <div className="flex flex-row  items-center mb-3">
                  <div className="w-[25px] h-[6px] bg-[#ce0d2d] rounded-full mr-3"></div>
                  <p className="mb-0 text-sm font-medium">
                    {t("dashboard.do")}
                  </p>
                </div>
                <div className="flex flex-row  items-center mb-3">
                  <div className="w-[25px] h-[6px] bg-[#c6cbd8] rounded-full mr-3"></div>
                  <p className="mb-0 text-sm font-medium">
                    {t("dashboard.doing")}
                  </p>
                </div>
                <div className="flex flex-row items-center mb-3">
                  <div className="w-[25px] h-[6px] bg-[#000] rounded-full mr-3"></div>
                  <p className="mb-0 text-sm font-medium">
                    {t("dashboard.done")}
                  </p>
                </div>
