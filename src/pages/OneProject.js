    ...
    <>
      <div className="flex flex-row justify-between">
        ...
        <section className="w-[65vw] h-full mr-10 pt-2">
              ...
              {userType === 1 ?
                  <button onClick={handleShowProject} className="py-1 ml-5 mb-3">
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      strokeWidth={1.5}
                      className="w-10 h-10 cursor-pointer stroke-black hover:stroke-[#ce0d2d]"
                    >
                      <path
                        strokeLinecap="round"
          ...
          <div className="w-full h-1 mt-3 rounded-xl bg-[#ce0d2d] "></div>
            ...
            <section className="w-full h-[20%] border-b-2 border-gray-200">
              ...
              <div className="w-full flex flex-row justify-between px-2 mt-2">
                <div className="w-[50%] pl-1 flex flex-row items-center mr-5">
                  ...
                  <div className="w-1 h-5 bg-[#c6cbd8] mx-2 rounded-2xl"></div>
              ...
              <div className="w-full h-[75%] mt-3 px-2 drop-shadow-md overflow-y-scroll">
                {
                  notes.length > 0 ?
                    ...
                    :
                    <p className="w-full pt-2 text-xs text-center text-gray-400 font-light">
                      {t("project.no-notes")}
                    </p>
